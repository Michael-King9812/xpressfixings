    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <h5 class="card-title mb-0">Total Problem Lists (<span style="color: red;">{{App\Models\PossibleProblems::count()}})</span></h5>
                            ...
                            <form action="{{route('admin.updateProblemsStore', [$problem->possibleProblems, $problem->remember_token])}}" method="post" class="form-horizontal form-material mx-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12" style="font-weight: bold;">
                                        <input type="text" name="add_problem" value="{{ $problem->possibleProblems ?? old('add_problem')}}" placeholder="Edit Problem"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12" style="font-weight: bold;">
                                        <input type="text" name="problem_price" value="{{ $problem->price ?? old('problem_price')}}" placeholder="Edit problem fixing price"
                                            class="form-control form-control-line">
                                    </div>
