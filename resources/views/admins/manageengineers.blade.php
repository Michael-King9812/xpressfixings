    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <h5 class="card-title mb-0">Total Engineers (<span style="color: red;">{{App\Models\Engineer::where('status','1')->count()}})</span></h5>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="datatables-basic" class="table table-striped" style="width:100%">
                        ...
                        <tbody>
                            @foreach($viewEngineers as $EngineerDetails)
                                <tr>
