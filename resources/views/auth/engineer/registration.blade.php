	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('{{asset('images/bg-01.jpg')}}');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				...
				<form action="{{route('addEngineerStore')}}" method="POST" class="login100-form validate-form">
					@csrf
					...
					<div class="m-b-23" style="color: darkred;">@error('name') {{$message}} @enderror</div>
					...
					<div class="wrap-input100 validate-input" data-validate = "Full Name is Required">
						...
						<input class="input100" type="text" name="phone" value="{{old('phone')}}" placeholder="Enter your Phone Number">
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>
					<div class="m-b-23" style="color: darkred;">@error('phone') {{$message}} @enderror</div>

					<div class="wrap-input100 validate-input" data-validate = "Full Name is Required">
						<span class="label-input100">Address</span>
						<input class="input100" type="text" name="address" value="{{old('address')}}" placeholder="Enter your Shop Address">
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>
					...
					<div class="wrap-input100 validate-input" data-validate = "Full Name is Required">
						...
						<input class="input100" type="text" name="city" value="{{old('city')}}" placeholder="Enter your Shop City">
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>
