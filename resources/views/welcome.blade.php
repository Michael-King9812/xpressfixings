...
@section('main')
    ...
    <main class="l-main">
            ...
            <section class="home" id="home">
                    ...
                    <!--===== APP =======-->
            <section class="app section bd-container" data-aos="zoom-out-up" data-aos-duration="3000">
                <div class="app__container bd-grid">
                    ...
                    <img src="{{asset('images/mobile/galaxy-view2.png')}}" data-aos="fade-up"
     data-aos-duration="2000" alt="" class="about__img">
                </div>
            ...
            <!--========== ABOUT ==========-->
            <section class="about section bd-container" id="about" data-aos="fade-left">
                <div class="about__container  bd-grid">
                    <img src="{{asset('images/mobile/imac-21-5-2019.png')}}" alt="" data-aos="fade-right" data-aos-duration="3000" class="about__img">
...
One of our Technicians very close to your location will be directed to you  to work on the device and repair it. Xpressfixing even offers a 2-month warranty and a week-long money back guarantee. Can it get any better than this?</p>
            ...
            <section class="services section bd-container" id="services">
                ...
                <div class="services__container  bd-grid">
                    <div class="services__content" data-aos="fade-up" data-aos-duration="3000">
                        <img class="services__img" src="{{asset('images/styling-images/20210105055123.png')}}" alt="">
                        <h3 class="services__title" style="font-weight: bold;">PHONE AND SYSTEM REPAIR</h3>
                        <p class="services__description">We offer our clients excellent quality services for many years, with the best and Matchless service in the city.</p>
                    </div>




                    <div class="services__content" data-aos="fade-up" data-aos-duration="4000">
                        ...
                        <h3 class="services__title" style="font-weight: bold;">WE REFURBISHED SMARTPHONES</h3>
                        <p class="services__description">What makes it different from a new device is that it has been lightly used before it came into us. We fix whatever issues it might have had. It comes at an affordable price with a quality that makes it looks as good as new, so that you do not have to compromise with your smartphone experience. 
                            Our refurbished phones have at least 4 months of warranty</p>
                    </div>
                    ...
                    <div class="services__content"  data-aos="fade-up" data-aos-duration="3000">
                        ...
                        <h3 class="services__title" style="font-weight: bold;">SELLING AND SWAPPING OF PHONES</h3>
                        <p class="services__description">We offer our clients excellent quality services for many years, with the best and quality service.</p>
                    </div>
            ...
            <section class="menu section bd-container" id="menu">
                ...
                <h2 class="section-title" style="font-weight: bold;">Our Area of Service</h2>

                <div class="menu__container bd-grid">
                    <div class="menu__content">
                        <img class="menu__img" src="{{asset('images/styling-images/20210105055025.png')}}" style="width: 170px; height: 160px;" alt=""><br>
                        <h3 class="menu__name"><center>BUYING AND SWAPPING OF PHONES</center></h3>
                    ...
                    <div class="menu__content">
                        <img class="menu__img" src="{{asset('images/styling-images/20210105055123.png')}}" style="width: 170px; height: 160px;" alt=""><br>
                        <h3 class="menu__name"><center>SELLING OF GADGETS</center></h3>
                        <!-- <span class="menu__detail">Delicious dish</span>
                    ...
                    <div class="menu__content">
                        <img class="menu__img" src="{{asset('images/styling-images/20210105055142.png')}}" style="width: 170px; height: 160px;" alt=""><br>
                        <h3 class="menu__name"><center>SELLING</center></h3>
                        <!-- <span class="menu__detail">Delicious dish</span>
            ...
            <section class="app section bd-container">
                <div class="app__container bd-grid">
                    <div class="app__data" data-aos="flip-left" data-aos-duration="9000">
                        <!-- <span class="section-subtitle app__initial">Mobile</span> -->
                        <h2 class="section-title app__initial" style="font-weight: bold;">WHAT EXPERT AND EXPERIENCE ENGINEER SAY</h2>
                        <p class="app__description">Xpressfixing has been a revolutionized startup that has brought  so much value to  customers and will continue that way. We are proud to partner with them and help our all phones users get better exchange value for their phones,  cheap repair and fast and quick delivery.</p>
                        <div class="app__stores">
                            <!-- <a href="#"><img src="{{asset('customers/assets/img/app1.png')}}" alt="" class="app__store"></a> -->
                            <!-- <button style="padding: 12px 25px; font-size: 15px; font-weight: bold; border-radius: 10px; border: none; background: green; color: white; cursor: pointer">Try Us Today</button> -->
                            <div class="contact__button">
                        <a href="{{route('auth.login')}}" class="button">Login</a> <a href="{{route('auth.registration')}}" class="button">Try us Today</a>
                    </div>
                        </div>
                    </div>

                    <img src="{{asset('images/mobile/20201003132506.png')}}" alt="" class="app__img" data-aos="fade-left" data-aos-duration="7000">
                </div>
            </section>

            <!--========== CONTACT US ==========-->
            <section class="contact section bd-container" id="contact" data-aos="fade-up" data-aos-duration="3000">
                <div class="contact__container bd-grid">
                    <div class="contact__data">
                        <span class="section-subtitle contact__initial">Let's talk</span>
                        <h2 class="section-title contact__initial" style="font-weight: bold">Contact us</h2>
                        <p class="contact__description">If you want to Visit or Communicate wit us, contact us and we will attend you quickly, with our 24/7 chat service.</p>
                    </div>
